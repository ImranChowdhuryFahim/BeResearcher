        ...
        return (
            <div className="VideoContainer">
                ...
                <div className="forwardbackward">
                    ...
                    }}><FontAwesomeIcon icon={faAngleLeft} style={{ paddingRight: '5px' }}>></FontAwesomeIcon> Previous Topic </span>
                    <span className="btn2" style={{
                ...
                <FontAwesomeIcon icon={faCheck} style={{ paddingLeft: '5px' }}></FontAwesomeIcon></span>
                    <span className="btn3" style={{
                        backgroundColor: '#112040',
                        padding: '15px', paddingRight: '34px', paddingLeft: '34px', color: 'white', borderRadius: '50px', marginLeft: 'auto', order: '3'
                    }} >Next Topic <FontAwesomeIcon icon={faAngleRight} style={{ paddingLeft: '5px' }}>></FontAwesomeIcon></span>
