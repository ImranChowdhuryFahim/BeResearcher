      ...
      return <Redirect to='/login'></Redirect>
        ...
        return (
            <div className={"coursevideosection"}>
                {(this.context.CourseContent!==null && this.context.CurrentUserDetails!==null && this.context.currentCourseProgress!==null && this.context.totalItem!==null && this.context.CurrentContentDetails!==null)?(<div className="CourseSection">
